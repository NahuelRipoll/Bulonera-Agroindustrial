                ...
                {productosPagina.map((producto) => {
                  ...
                  return (
                    <div
                      ...
                      className="bg-white rounded-xl border border-gray-200 overflow-hidden hover:shadow-lg transition-shadow flex flex-col cursor-pointer focus:outline-none focus:ring-2 focus:ring-orange-500"
                    >
      ...
      {productoSeleccionado && (
        ...
        >
          <div
            role="dialog"
            aria-modal="true"
            aria-labelledby="catalogo-producto-modal-title"
            className="bg-white rounded-xl shadow-2xl w-full max-w-3xl max-h-[90vh] overflow-y-auto"
            onClick={(event) => event.stopPropagation()}
          >
            <div className="flex items-start justify-between border-b border-gray-100 px-6 py-4 gap-4">
              <div>
                {productoSeleccionado.rubros && (
                  <p className="text-xs font-semibold uppercase text-orange-500">
                    {productoSeleccionado.rubros.nombre}
                  </p>
                )}
                <h2
                  id="catalogo-producto-modal-title"
                ...
                <div className="mt-6 flex flex-wrap gap-3">
                  <a
                    href={`https://wa.me/${PHONE_WA}?text=${encodeURIComponent(
                      `Hola, me interesa el producto: ${productoSeleccionado.nombre}`
                    )}`}
                    target="_blank"
                    rel="noopener noreferrer"
